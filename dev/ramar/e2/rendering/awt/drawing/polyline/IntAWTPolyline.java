...
public class IntAWTPolyline implements Drawable, Iterable<Vec2>
{
    ...
    {
        private IntAWTPolyline pline;
        private int currDex = 0;
        public PolyLineIterator(IntAWTPolyline pline)
        {
            this.pline = pline;
        }

        public PolyLineIterator(IntAWTPolyline pline, int startDex)
        {
    ...
    public IntAWTPolyline addPoint(double x, double y)
    {
    ...
    public IntAWTPolyline addOffset(double x, double y)
    {
        double xOff = 0.0,
               yOff = 0.0;
        if( this.xs.length > 0 )
    ...
    {
        IntAWTPolylineDrawer pline = (IntAWTPolylineDrawer)vp.draw.polyline;
        pline.withMod(mods);
