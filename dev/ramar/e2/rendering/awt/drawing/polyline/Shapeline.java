...
public class Shapeline implements Shape, Drawable
{
    ...
    public Shapeline addPoint(double x, double y)
    {   
        synchronized(this)
        {
    ...
    public synchronized Shapeline removePoint(int i)
    {
        if( !this.isEmpty() ) 
        {
            int size = this.size();
    ...
    public synchronized Shapeline withPoint(int i, double x, double y)
    {
        this.xs[i] = x;
        this.ys[i] = y;
    ...
    public synchronized Shapeline modPoint(int i, double x, double y)
    {
        this.xs[i] += x;
        this.ys[i] += y;
    ...
    */
    ...
    {
        return new ShapelinePathIterator(this, at);
    }
    ...
    class ShapelinePathIterator implements PathIterator
    {
        AffineTransform at = null;
        Shapeline sl = null;
        int ii = 0;

        public ShapelinePathIterator(Shapeline sl, AffineTransform at)
        {
            this.sl = sl;
            this.at = at;
        }
